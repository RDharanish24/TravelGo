...
export default function SearchResults() {
  ...
  const handleSelectBooking = (item) => {
    // Set the item in global context and move to seat selection
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
          <div>
            ...
            >
              <span className="capitalize">{searchParams.type}</span> Options
            </motion.h1>
          ...
          {searchResults.length > 0 ? (
            ...
            >
              ...
              <p className="text-gray-500 mt-2 max-w-xs mx-auto">
                We couldn't find any {searchParams.type}s for this route. Try changing your dates or locations.
              </p>
              <Button 
                variant="primary" 
                className="mt-6" 
        ...
        {/* Trust Badge / Info */}
        <div className="mt-12 text-center text-gray-400 text-sm flex items-center justify-center space-x-2">
          <Search className="h-4 w-4" />
          <span>All prices include basic travel insurance.</span>
        </div>
      </div>
    </motion.div>
  );
